...
lines = {
  ...
  :SIX => ['Grand Central','33rd','6-28th','23rd','Union Square','Astor Place']
}

p "(N) 'Times Square', '34th', '28th', '23rd', 'Union Square', '8th' "
p "(L) 'L-8th','6th','Union Square','3rd','1st' "
p "(SIX) 'Grand Central','33rd','6-28th','23rd','Union Square','Astor Place' "
puts " "
...
if start_line != ending_line
   intersect = lines[start_line.to_sym] & lines[ending_line.to_sym]
end
