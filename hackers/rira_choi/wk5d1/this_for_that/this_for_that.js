...
// We're going to recreate a console version of this site. What does your startup do?
// Let's practice using arrays to find out!
...
var randomPicked = function(x, y){
    var thisPicked = x[Math.floor(Math.random() * _this.length)];
    var thatPicked = y[Math.floor(Math.random() * _that.length)];
    saying = console.log("So.... your startup is basically like a " + thisPicked + " for " + thatPicked + "?");
}

randomPicked(_this, _that);
